...
const NotVerifNumberCard = () => {
  return (
    <div className="flex flex-col py-4 justify-center items-center">
      ...
      />
      <h1 className="font-bold text-2xl text-[#CB3A31] text-center">
      ...
      <Link
        to="/register"
        className="w-[100%] h-[48px] bg-[#333999] hover:bg-[#212674] transition duration-300 mt-8 mb-5 flex justify-center items-center text-white rounded-lg"
      >
