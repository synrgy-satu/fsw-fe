...
//   private static dataDummy: dailyTransaction[];
...
//   public static getPeriodiclyTransaction = (index: number, dataDummy: dailyTransaction[]) => {
//     switch (index) {
//       case 0:
//         return DummyData.getAggregateTransactionPeriodly(dataDummy, "month");
